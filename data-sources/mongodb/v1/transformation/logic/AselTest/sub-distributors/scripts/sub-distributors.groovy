...
if (!validRecords.isEmpty()) {
    ...
    log.info("Transferred ${validRecords.size()} valid sub-distributor records to success")
}
...
if (!invalidRecords.isEmpty()) {
    ...
    log.warn("Transferred ${invalidRecords.size()} invalid sub-distributor records to failure")
}
